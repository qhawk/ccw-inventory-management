        ...
        <div class="card-header">
          ...
          <div class="relative flex items-center">
            ...
            <input
              ...
              class="w-full pl-9 pr-9 py-2 rounded-lg border border-slate-200 bg-white text-sm text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-colors"
            />
            <button
              v-if="searchQuery"
              @click="searchQuery = ''"
